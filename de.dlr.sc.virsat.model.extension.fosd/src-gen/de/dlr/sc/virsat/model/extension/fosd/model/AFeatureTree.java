...
public abstract class AFeatureTree extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {
	...
	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.fosd.FeatureTree";
	 ...
	 */
	public AFeatureTree(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "FeatureTree");
	 ...
	 */
	public AFeatureTree(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
