...
public abstract class AFeature extends ABeanStructuralElementInstance implements IBeanStructuralElementInstance {
	...
	public static final String FULL_QUALIFIED_STRUCTURAL_ELEMENT_NAME = "de.dlr.sc.virsat.model.extension.fosd.Feature";
	 ...
	 */
	public AFeature(Concept concept) {
		StructuralElement seFromActiveConcept = ActiveConceptHelper.getStructuralElement(concept, "Feature");
	 ...
	 */
	public AFeature(StructuralElementInstance sei) {
		setStructuralElementInstance(sei);
	}
