 ...
 *******************************************************************************/
package de.dlr.sc.virsat.model.extension.fosd.util;
...
public class ProductStructureHelper {
	...
	public static ABeanStructuralElementInstance createTreeModel(StructuralElementInstance sc) {
		...
		if (scTypeName.equals(ProductTree.class.getSimpleName())) {
			structuralElementName = FeatureTree.class.getSimpleName();
			childrenTypeName = Feature.class.getSimpleName();
			
			
			se = ach.getStructuralElement("de.dlr.sc.virsat.model.extension.fosd.FeatureTree");
		} else if (scTypeName.equals(FeatureTree.class.getSimpleName())) {
			structuralElementName = ConfigurationTree.class.getSimpleName();
			childrenTypeName = ElementConfiguration.class.getSimpleName();
			se = ach.getStructuralElement("de.dlr.sc.virsat.model.extension.ps.ConfigurationTree");
		}

		
		ABeanStructuralElementInstance absc = createBean(se, ed.getResourceSet().getRepository().getAssignedDiscipline());
	...
	public static ABeanStructuralElementInstance getChildren(StructuralElementInstance sc, String structuralElementName, Concept concept) {
		...
		if ((scTypeName.equals(ProductTreeDomain.class.getSimpleName())) || (scTypeName.equals(ElementDefinition.class.getSimpleName()))) {
			structuralElement = ach.getStructuralElement("de.dlr.sc.virsat.model.extension.fosd.Feature");
		} else if (sc.getType().getName().equals(Feature.class.getSimpleName())) {
			structuralElement = ach.getStructuralElement("de.dlr.sc.virsat.model.extension.ps.ElementConfiguration");
		}
