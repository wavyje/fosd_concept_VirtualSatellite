...
public class VariantSelectionWizard extends Wizard implements INewWizard {

	private VariantSelectionPage generate;
	...
	public VariantSelectionWizard() {
		super();
		setWindowTitle("Generate Feature Wizard");
	}
	/**
	...
	public void addPages() {
		generate = new VariantSelectionPage(selection);
		addPage(generate);
	}
	@Override
