...
public class GenerateFeatureWizard extends Wizard implements INewWizard {

	private GenerateFeaturePage generate;
	...
	public void addPages() {
		generate = new GenerateFeaturePage(selection);
		addPage(generate);
	}
	@Override
