...
import de.dlr.sc.virsat.model.extension.fosd.ui.wizards.StructuralElementInstanceMappingBean;
import de.dlr.sc.virsat.model.extension.fosd.ui.wizards.VirsatSemanticTreeMapperSupport;
/**
...
public class ConfigureFeatureTreePage extends WizardPage {
	...
	private boolean isModifyFeatureTree;
	/**
	 * Create a new regenerate page
	 * @param preselect the root element for the selection
	 */
	protected ConfigureFeatureTreePage(ISelection preselect) {	
		super("");
