...
public class ConfigureFeatureTreeWizard extends Wizard implements INewWizard {

	private ConfigureFeatureTreePage configurePage;
	private ISelection selection;

	/**
	 * Create a new Generate Wizard 
	 */
	public ConfigureFeatureTreeWizard() {
		super();
		setWindowTitle("Configure FeatureTree Wizard");
	}
	...
	public void addPages() {
		super.addPages();
		configurePage = new ConfigureFeatureTreePage(selection);
